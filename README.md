...
- **Reconstruction**: Rebuilds images using top-k components to evaluate quality degradation.
...
3. Cells execute sequentially: imports, data display, PCA computation, and reconstruction plots.
...
Expected outputs show progressive improvement in reconstruction fidelity as k increases.
